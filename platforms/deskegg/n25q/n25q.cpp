...
void
N25Q::ReadID(int * id_string, int length) {
...
void
N25Q::ReadDataFromAddress(int * dataBuffer, int startingAddress, int length) {
	testprintf("\r\nEntering %s ...", __PRETTY_FUNCTION__);
...
void
N25Q::ProgramFromAddress(int * dataBuffer, int startingAddress, int length){
	testprintf("\r\nEntering %s ...", __PRETTY_FUNCTION__);
...
void
N25Q::NonBlockingProgramFromAddress(int * dataBuffer, int startingAddress, int length){
	testprintf("\r\nEntering %s ...", __PRETTY_FUNCTION__);
...
void
N25Q::SPIReadNBytes(int * rxBuffer, int length) {
	dbgprintf("Response:\r\n");
