...
public:
	...
	void ReadID(int * id_string, int length=READ_ID_LEN);
	void ReadDataFromAddress(int * dataBuffer, int startingAddress, int length);
	void ProgramFromAddress(int * dataBuffer, int startingAddress, int length);
	void NonBlockingProgramFromAddress(int * dataBuffer, int startingAddress, int length);
...
private:
	...
	void SPIReadNBytes(int * rxBuffer, int length);
	void SPIInit(void);
